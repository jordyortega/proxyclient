...
public void run() {
    ...
    {
        boolean exists = (new File(System.getProperty("user.home") + "/web3scapecache/")).exists();
        if (exists) {
            return System.getProperty("user.home") + "/web3scapecache/";
        } else {
            File f = new File(System.getProperty("user.home") + "/web3scapecache/");
            f.mkdir();
            return System.getProperty("user.home") + "/web3scapecache/";
        }
    }
