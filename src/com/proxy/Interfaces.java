...
public class Interfaces extends RSInterface {
	...
	public static void loadInterfaces(StreamLoader streamLoader,TextDrawingArea textDrawingAreas[]) {
		...
		newBank();
		teleportInterfaceScroll(textDrawingAreas);
		teleportInterface(textDrawingAreas);
		smallTeleportInterface(textDrawingAreas);
		achievementsInterfaceScroll(textDrawingAreas);
		questsInterfaceScroll(textDrawingAreas);
	}
	
	private static void newBank(){
		RSInterface Interface = addTabInterface(5292);
		setChildren(17, Interface);
		addSprite(5293, 25, "Interfaces/Bank/BANK");
		...
		addBankHover(21000, 4, 21001, 5, 8, "Interfaces/Bank/BANK", 35, 25, 304, 1, "Swap Withdraw Mode", 21002, 7, 6, "Interfaces/Bank/BANK", 21003, "Switch to insert items \nmode", "Switch to swap items \nmode.", 12, 20);
		setBounds(21000, 25, 285, 7, Interface);
		setBounds(21001, 10, 225, 8, Interface);
		addBankHover(21004, 4, 21005, 13, 15, "Interfaces/Bank/BANK", 35, 25, 0, 1, "Search", 21006, 14, 16, "Interfaces/Bank/BANK", 21007, "Click here to search your \nbank", "Click here to search your \nbank", 12, 20);
		setBounds(21004, 65, 285, 9, Interface);
		setBounds(21005, 50, 225, 10, Interface);
		addBankHover(21008, 4, 21009, 9, 11, "Interfaces/Bank/BANK", 35, 25, 115, 1, "Search", 21010, 10, 12, "Interfaces/Bank/BANK", 21011, "Switch to note withdrawal \nmode", "Switch to item withdrawal \nmode", 12, 20);
		setBounds(21008, 240, 285, 11, Interface);
		setBounds(21009, 225, 225, 12, Interface);
		addBankHover1(21012, 5, 21013, 17, "Interfaces/Bank/BANK", 35, 25, "Deposit carried tems", 21014, 18, "Interfaces/Bank/BANK", 21015, "Empty your backpack into\nyour bank", 0, 20);
		setBounds(21012, 415, 285, 13, Interface);//375 285
		setBounds(21013, 400, 225, 14, Interface);//360 225
		addBankHover1(21016, 5, 21017, 19, "Interfaces/Bank/BANK", 35, 25, "Deposit worn items", 21018, 20, "Interfaces/Bank/BANK", 21019, "Empty the items your are\nwearing into your bank", 0, 20);
		setBounds(21016, 455, 285, 15, Interface);
		setBounds(21017, 440, 225, 16, Interface);
		//setBounds(21016, 415, 285, 15, Interface);
		//setBounds(21017, 400, 225, 16, Interface);
		//addBankHover1(21020, 5, 21021, 21, "Interfaces/Bank/BANK", 35, 25, "Deposit beast of burden inventory.", 21022, 22, "Interfaces/Bank/BANK", 21023, "Empty your BoB's inventory\ninto your bank", 0, 20);
		//setBounds(21020, 455, 285, 17, Interface);
		//setBounds(21021, 440, 225, 18, Interface);
		setBounds(5383, 170, 16, 1, Interface);
...
*/
	...
	public static void Skill(TextDrawingArea[] TDA) {
		...
		addButton(19747, 51, "Skill/CUSTOM5", "View @or1@Hunter @whi@guide", -1, 1, 166, 32);
		addButton(19748, 50, "Skill/CUSTOM5", "View @or1@Construction @whi@guide", -1, 1, 166, 32);
		// drawTooltip(22005, 257, "aaaa");
		// drawTooltip(22006, 258, "bbbbb");
		// addTooltip(22005, "aaa\nbbb");
		addText(22000, "1", 0xFFFF00, false, true, -1, TDA, 0);
		addText(22001, "1", 0xFFFF00, false, true, -1, TDA, 0);
		addText(22002, "0", 0xFFFF00, false, false, -1, TDA, 0);
		addText(22003, "Total lvl:", 0xFFFF00, false, false, -1, TDA, 0);
		addText(22004, "", 0xFFFF00, true, false, -1, TDA, 1, 100);
		for(int k = 0; k < boxIds.length; k++) {
			skillInterface(boxIds[k], 256);
		}
		
		RSInterface rsInterface = addTabInterface(3917);
		rsInterface.totalChildren(63);
		rsInterface.child(0, 3918, 0, 0);
		rsInterface.child(1, 3925, 0, 31);
		rsInterface.child(2, 3932, 0, 62);
		rsInterface.child(3, 3939, 0, 93);
		rsInterface.child(4, 3946, 0, 124);
		rsInterface.child(5, 3953, 0, 155);
		rsInterface.child(6, 4148, 0, 186);
		rsInterface.child(7, 19746, 70, 69);
		rsInterface.child(8, 19748, 1, 219);
		rsInterface.child(9, 19747, 64, 219);
		rsInterface.child(10, 14000, 10, 219);
		rsInterface.child(11, 19749, 127, 221);
		rsInterface.child(12, 22003, 135, 226); //total level:
		rsInterface.child(13, 22004, 142, 233);
		rsInterface.child(14, 22002, 129, 239); //level
		rsInterface.child(15, 22001, 99, 222);
		rsInterface.child(16, 22001, 110, 235);
		rsInterface.child(17, 22000, 36, 222);
		rsInterface.child(18, 22000, 47, 235);
		rsInterface.child(19, 4040, 5, 20);
		rsInterface.child(20, 8654, 0, 2);
		rsInterface.child(21, 8655, 64, 2);
		rsInterface.child(22, 4076, 20, 20);
		rsInterface.child(23, 8656, 128, 2);
		rsInterface.child(24, 4112, 20, 20);
		rsInterface.child(25, 8657, 0, 33);
		rsInterface.child(26, 4046, 20, 50);
		rsInterface.child(27, 8658, 64, 33);
		rsInterface.child(28, 4082, 20, 50);
		rsInterface.child(29, 8659, 128, 33);
		rsInterface.child(30, 4118, 20, 50);
		rsInterface.child(31, 8660, 0, 60+10);
		rsInterface.child(32, 4052, 20, 83);
		rsInterface.child(33, 8661, 65, 60+10);
		rsInterface.child(34, 4088, 20, 83);
		rsInterface.child(35, 8662, 130, 60+10);
		rsInterface.child(36, 4124, 20, 83);
		rsInterface.child(37, 8663, 0, 90+10);
		rsInterface.child(38, 4058, 20, 120);
		rsInterface.child(39, 8664, 65, 90+10);
		rsInterface.child(40, 4094, 20, 120);
		rsInterface.child(41, 8665, 130, 90+10);
		rsInterface.child(42, 4130, 20, 120);
		rsInterface.child(43, 8666, 0, 130);
		rsInterface.child(44, 4064, 20, 150);
		rsInterface.child(45, 8667, 65, 130);
		rsInterface.child(46, 4100, 20, 150);
		rsInterface.child(47, 8668, 130, 130);
		rsInterface.child(48, 4136, 20, 150);
		rsInterface.child(49, 8669, 0, 160);
		rsInterface.child(50, 4070, 20, 180);
		rsInterface.child(51, 8670, 65, 160);
		rsInterface.child(52, 4106, 20, 180);
		rsInterface.child(53, 8671, 130, 160);
		rsInterface.child(54, 4142, 20, 180);
		rsInterface.child(55, 8672, 0, 190);
		rsInterface.child(56, 4160, 20, 150);
		rsInterface.child(57, 8672, 0, 190);
		rsInterface.child(58, 4160, 20, 150);
		rsInterface.child(59, 12162, 65, 190);
		rsInterface.child(60, 2832, 20, 150);
		rsInterface.child(61, 13928, 130, 190);
		rsInterface.child(62, 13917, 20, 150);
		//rsInterface.child(63, 22005, 29, 191);
		//rsInterface.child(64, 22006, 29, 191);
		// setBounds(22005, 29, 191, 63, rsInterface);
	}
	...
	public static void skillActionButton(int id, int sprite, int sprite2, int requiredValues, String tooltip, int hoverId, int hoverSprite) {
		...
		Tab.width = 26;
		Tab.height = 34;
		Tab.mOverInterToTrigger = hoverId;
		Tab.tooltip = tooltip;
		Tab.sprite1 = imageLoader(sprite, "Skill/CUSTOM5");
		Tab.sprite2 = imageLoader(sprite2, "Skill/CUSTOM5");
		Tab.anIntArray245 = new int[1];
		Tab.anIntArray212 = new int[1];
		Tab.anIntArray245[0] = 1;
		Tab.anIntArray212[0] = requiredValues + 1;
		Tab.valueIndexArray = new int[1][3];
		Tab.valueIndexArray[0][0] = 2;
		Tab.valueIndexArray[0][1] = 5;
		Tab.valueIndexArray[0][2] = 0;
		RSInterface Interface = addTabInterface(hoverId);
		Interface.id = hoverId;
		Interface.parentID = 3917;
		Interface.type = 0;
		...
		addSprite(hoverId + 1, hoverSprite, "Skill/CUSTOM5");
		setChildren(1, Interface);
		setBounds(hoverId + 1, 29, 191, 0, Interface);
	}

public static int boxIds[] = { 4041, 4077, 4113, 4047, 4083, 4119, 4053, 4089, 4125, 4059, 4095, 4131, 4065, 4101, 4137, 4071, 4107, 4143, 4154, 12168, 13918, 22005, 22006};
	...
	public static void configureLunar(TextDrawingArea[] TDA) {
		...
		addLunar3RunesBigBox(30138, 9075, 563, 554, 1, 1, 2, 30012, 30003, 74,"Skilling Teleports", "Teleports you to the Barbarian\\noutpost",TDA, 15,0,5);
		...
		addLunar3RunesSmallBox(30162, 9075, 563, 555, 1, 1, 3, 30012, 30004, 77, "Training Teleport","Teleports you to Port khazard",TDA,18,0,5);
