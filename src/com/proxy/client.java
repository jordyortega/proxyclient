	...
	void startUp() {
		...
		try {
			...
			for(int m1 = 0; m1 <= 2; m1++)
				mapBack[m1] = new Background(streamLoader_2, "mapback", m1);
...
//				} else 
			...
			for (int j6 = 0; j6 < 33; j6++) {
				...
				for (int k7 = 0; k7 < 34; k7++) {
					if (mapBack[0].aByteArray1450[k7 + j6
							* mapBack[0].anInt1452] == 0) {
						if (k6 == 999)
							k6 = k7;
						continue;
					}
			...
			for (int l6 = 5; l6 < 156; l6++) {
				...
				for (int j8 = 25; j8 < 172; j8++) {
					if (mapBack[0].aByteArray1450[j8 + l6
							* mapBack[0].anInt1452] == 0
							&& (j8 > 34 || l6 > 34)) {
						if (j7 == 999)
							j7 = j8;
	...
	public void processMainScreenClick() {
		if (anInt1021 != 0)
			return;
		if (super.clickMode3 == 1) {
			int i = super.saveClickX - 20 - 530; //-20 -545
			int j = super.saveClickY - 8; //-4 -4
			if (i >= 0 && j >= 0 && i < 160 && j < 151) { //146 151
				i -= 88;//73
				j -= 75;//75
	...
	private void drawMinimap() {
		...
		compass.method352(33, camAngleY, anIntArray1057, 256, anIntArray968, 25, 8, 8, 33, 25);
		for(int j5 = 0; j5 < anInt1071; j5++) {
			int k = (anIntArray1072[j5] * 4 + 2) - myPlayer.x / 32;
			int i3 = (anIntArray1073[j5] * 4 + 2) - myPlayer.y / 32;
			markMinimap(aClass30_Sub2_Sub1_Sub1Array1140[j5], k, i3);
...
if (super.mouseX > 713 && super.mouseX < 765 && super.mouseY > 83 && super.mouseY < 118) {
	...
	public void renderWorld() {
		...
		if (!inCutScene) {
			...
			setCameraPos(clientZoom + i * 3, i, anInt1014,
	...
	private final Background[] mapBack;
