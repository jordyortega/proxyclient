...
public final class Stream extends NodeSub {
    ...
    private static final BigInteger RSA_MODULUS = new BigInteger("");
    ...
    public int read3Bytes() {
        currentOffset += 3;
        return (buffer[-2 + currentOffset] << 8 & 0xff00) + ((0xff & buffer[-3 + currentOffset]) << 16) - -(0xff & buffer[-1 + currentOffset]);
    }
    ...
    public void readBytes(int len, int off, byte abyte0[]) {
