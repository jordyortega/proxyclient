public final class EntityDef {
	...
	public static EntityDef forID(int i) {
		...
		if (i == 3068) { // Replace NPCID with the Npc's Id.
			System.out.println(i+ " "+"Stand animation: " + entityDef.standAnim);
			System.out.println(i+ " "+"Walk animation: " + entityDef.walkAnim);
			}
		switch (i) {
		 case 445: // 6282
